<template>
  <div class="login-page">  
    <div class="container">
      ...
      <div class="alert alert-danger" v-if="(user && user.role != 'user')">Usted no tiene permitido llenar este formulario.</div>
      ...
      <form class="user-form" @submit.prevent="submit" v-else>
        ...
        <div class="form-group">
          <input type="text" v-model="account.ruc" class="form-control" placeholder="RUC" required="">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <input type="text" v-model="account.dni" class="form-control" placeholder="DNI" required="">
        </div>
        <div class="form-group">
